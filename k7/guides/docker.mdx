...
```bash
k7 create --docker --backend k7d ubuntu:24.04 builder
k7 shell builder
...
| `k7d-fc` | Same guest service, VM under the Firecracker jailer | Same | ✅ (see the [k7d-fc note](/k7/concepts/backends#k7d-fc) about exec after resume) | ✅ Same, child stays overlay2 | ❌ |
