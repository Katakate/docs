...
<Note>
Time warp is a native-engine feature. `backend: firecracker` / `runtimeClassName: k7-fc` VMs reject `dilation > 1` and warp requests with a named error — see [Backends](/k7d/concepts/backends).
</Note>
