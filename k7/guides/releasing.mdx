...
### Publish k7-sdk (PyPI SDK) locally
1) Bump version in `src/k7_sdk/__init__.py`.
2) Build and upload:
```bash
...
Notes:
- PyPI **`k7-sdk`** (`src/k7_sdk/`); optional **`katakate`** shim. Assets in `src/k7/*` are not part of the SDK wheel.
