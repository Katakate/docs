...
k7 install --backend k7d --k7d-version 0.2.1   # pin the k7d release (k7 0.2.2+ default; required on PPA 0.2.1)
k7 install --backend k7d --k7d-artifact /root/k7d-v0.2.1-x86_64-linux.tar.gz   # install from a local tarball
